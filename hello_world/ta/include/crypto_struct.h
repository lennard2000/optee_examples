...
typedef struct TEE_OperationHandle psa_cipher_operation_t;
typedef struct TEE_OperationHandle psa_hash_operation_t;
typedef struct TEE_OperationHandle psa_sign_hash_operation_t;
typedef struct TEE_OperationHandle psa_mac_operation_t;
